<template>
  <div
    class="bg-[#FDFDFD] md:rounded-t-xl fixed left-0 md:left-auto bottom-0 md:right-5 w-screen md:w-[60%] 2xl:w-1/2 h-dvh md:h-[calc(100dvh-20px)] z-40 py-6 overflow-y-auto custom-scrollbar">
    <!-- mobile corss -->
    <div @click="emit('close')" class="cursor-pointer md:hidden absolute right-2 top-0.5">
