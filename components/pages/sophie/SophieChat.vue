<template>
  <section class="flex flex-col gap-2 size-full overflow-hidden h-full">
    <div class="flex-1 overflow-y-auto no-scrollbar">
      <div class="size-full overflow-hidden flex flex-col gap-4">
        <!-- chat -->
        <div
          ref="chatContainer"
            ...
            >
              <div class="flex-1 text-[#181D27]">
                <p class="font-semibold text-lg mb-1.5 text-[#175CD3]">
                  Welcome {{ appStore.userData?.name }} 👋
                </p>
                <p class="font-medium text-[#181D27]">
                  Meet Sophie, your AI guide for study abroad success. Ask
                  Sophie anything - from choosing universities to perfecting
                  your application. Just type your question or pick a suggested
                  prompt to get started.
                </p>
              </div>
              <div @click="welcomeMessage = false" class="cursor-pointer">
        ...
        <div class="flex flex-col gap-4">
          ...
          >
            <div
              v-for="(question, idx) in sophieStore.roadmapTaskDetail?.common_questions_prompt || preQuestion"
              :key="idx"
...
const welcomeMessage = ref<boolean>();
