  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "background-brand-subtle-hovered": "var(--color-background-brand-subtle-hovered)",
        ...
        "background-error-subtle": "var(--color-background-error-subtle)",
        "background-success-subtle": "var(--color-background-success-subtle)",
